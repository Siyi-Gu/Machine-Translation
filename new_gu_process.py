...
en_raw = open("dara/train.en", 'r',encoding='utf-8').readlines()
...
gu_train, gu_valid = train_test_split(gu_raw,test_size=0.2,random_state=42)
en_train, en_valid = train_test_split(en_raw,test_size=0.2,random_state=42)
